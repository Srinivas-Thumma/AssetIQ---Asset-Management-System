...
export default function OffboardingChecklistModal({ isOpen, onClose, employeeId, employeeName, onReturnAll }) {
  ...
  return (
    <div className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4 cursor-pointer" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-lg border border-slate-100 cursor-default" onClick={(e) => e.stopPropagation()}>
